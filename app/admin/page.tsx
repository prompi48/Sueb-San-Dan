/*
app/admin/page.tsx
หน้าควบคุมสำหรับ Admin ในการอนุมัติหรือปฏิเสธโพสต์ที่รอการตรวจสอบ

-ไม่ได้สั่งลบหรืออนุมัติลง Database ทันที แต่ใช้เทคนิค Optimistic UI:
เมื่อ Admin กดปุ่ม โพสต์จะหายไปจากหน้าจอทันที (ให้ความรู้สึกรวดเร็ว) แต่ระบบจะเก็บข้อมูลไว้ใน pendingAction และตั้งเวลาถอยหลัง 3 วินาที (setTimeout)
หาก Admin เปลี่ยนใจหรือกดผิด สามารถกด UNDO เพื่อดึงโพสต์กลับมาได้ก่อนที่เวลาจะหมด
ช่วยลดภาระการทำงานของ Database (DB Write)

-มีการเช็คสิทธิ์อย่างเข้มงวดก่อนจะ Render หน้าจอ:
Session Check: ตรวจสอบว่าล็อกอินหรือยัง
Role Check: ตรวจสอบจากตาราง profiles ว่า role === 'admin' จริงหรือไม่

-ถ้าออกก่อนที่การ approve จะถูกเขียนลง Database (ยังอยู่ในช่วง 3 วินาที)
จะ execute การ approve นั้นลง Database ทันที
*/
