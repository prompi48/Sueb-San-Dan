...
หน้าแก้ไขโพสต์ที่มีการดึงข้อมูลเก่ามาแสดงก่อนแก้ไข

ไม่ได้สร้าง Form ใหม่ซ้ำกับหน้า Create แต่สร้างคอมโพเนนต์กลาง PostForm ขึ้นมา แล้วส่ง initialData เข้าไปแทน
ลดความซ้ำซ้อนของโค้ด และทำให้การจัดการฟอร์มง่ายขึ้น

if (data.author_id !== session.user.id) { ... }
เช็คความปลอดภัยขั้นพื้นฐานว่า ถ้าไม่ใช่เจ้าของโพสต์นี้ ให้ไล่กลับหน้าหลักไปเลย ไม่ให้เห็นข้อมูลเก่าและฟอร์มแก้ไข

setPostData
เก็บข้อมูลเก่าที่ดึงมาจากฐานข้อมูลไว้ใน State เพื่อส่งต่อให้ PostForm แสดงเป็นค่าเริ่มต้น
*/
